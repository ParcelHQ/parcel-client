...
const ParcelFactoryContract = new Contract(PARCEL_FACTORY_ADDRESS, ParcelFactory.abi);
...
export const ContractProvider = ({ children }: { children: ReactNode }) => {
    const [contracts, dispatch] = useReducer(ContractReducer, initialContractState);

    return <ContractContext.Provider value={{ contracts, dispatch }}>{children}</ContractContext.Provider>;
};
